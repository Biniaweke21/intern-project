...
const employeeDetailSchemaStep1 = z.object({
    ...
    endDate: z.coerce.date({ required_error: " End date is required", message: "Invalid Date provided" }),
    dateOfHire: z.coerce.date({ required_error: "End date is required", message: "Invalid Date provided" }),
});
...
const EmployeeDetailForm: React.FC = () => {
    ...
    setValue('employeeId', id as string);
    ...
    const onSubmit = async (data: EmployeeDetailFormData) => {
        ...
        try {
            const response = await apiClient.post('/api/employee/detail', data);
            toast({
                    ...
                    <div>
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div className="space-y-4">
                                ...
                                <Select
                                    onValueChange={(value) => handleEmploymentStatusChange(value)}
                            ...
                            <div className="space-y-4">
                                <Label htmlFor="endDate">Date of  Hire</Label>
                                <Input
                                    id="dateOfHire"
                                    {...register("dateOfHire")}
                                    type="date"
                                ...
                                />
                                {errors.endDate && <p className="text-red-500">{errors.dateOfHire?.message}</p>}
                            </div>
                        </div>
